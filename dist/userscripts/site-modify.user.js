...
(function (Vue, ElementUI) {
  ...
  var __vue_staticRenderFns__ = [];
    ...
    const __vue_inject_styles__ = function (inject) {
      if (!inject) return
      inject("data-v-7180837e_0", { source: "#hero[data-v-7180837e]{padding:96px 32px;text-align:center}.tagline[data-v-7180837e]{font-size:76px;line-height:1.25;font-weight:900;letter-spacing:-1.5px;max-width:960px;margin:0 auto;background-clip:text;-webkit-background-clip:text;-webkit-text-fill-color:transparent}.actions a[data-v-7180837e]{font-size:16px;display:inline-block;background-color:#f1f1f1;padding:8px 18px;font-weight:500;border-radius:8px;transition:background-color .5s,color .5s}.actions .security[data-v-7180837e]{background:linear-gradient(#f1f1f1 #f1f1f1) padding-box,linear-gradient(45deg,#42d392,#647eff) border-box;border:2px solid transparent}.actions .security[data-v-7180837e]:hover{background:linear-gradient(#e5e5e5,#e5e5e5) padding-box,linear-gradient(45deg,#42d392,#647eff) border-box}.dark .actions .security[data-v-7180837e]:hover{background:linear-gradient(#3a3a3a,#3a3a3a) padding-box,linear-gradient(45deg,#42d392,#647eff) border-box}.actions .security .icon[data-v-7180837e]{width:12px;height:12px;margin-left:4px}.actions .get-started[data-v-7180837e],.actions .setup[data-v-7180837e]{margin-right:18px}.actions .icon[data-v-7180837e]{display:inline;position:relative;top:-1px;margin-left:2px;fill:currentColor;transition:transform .2s}.actions .get-started[data-v-7180837e]:hover{transition-duration:.2s}.actions .get-started:hover .icon[data-v-7180837e]{transform:translate(2px)}.actions .get-started[data-v-7180837e],.actions .security[data-v-7180837e],.actions .setup[data-v-7180837e]{color:#476582}.actions .get-started[data-v-7180837e]:hover,.actions .security[data-v-7180837e]:hover,.actions .setup[data-v-7180837e]:hover{background-color:#e5e5e5;transition-duration:.2s}", map: undefined, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__ = "data-v-7180837e";
    /* module identifier */
