...
export const Footer: FC<{
  ...
  return (
    <div className={styles.footer}>
      ...
      <a onClick={() => window.open("https://github.com/yanyue404/build-my-own-extension")}>
        <IconGithub />
      ...
      <a
        onClick={() =>
          window.open(
            "https://github.com/yanyue404/build-my-own-extension/tree/master/packages/force-copy/README.md"
          )
        }
      >
        <IconQuestionCircle />
